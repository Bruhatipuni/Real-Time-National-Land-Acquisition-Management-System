...
export function generateMinistryPDFReport({
  ...
  doc.text('BHUSETU: NATIONAL LAND ACQUISITION SYSTEM', 14, 15);
  ...
  doc.text('Confidential - For Central Ministry Official Use Only | BhuSetu National Command Center', 14, 287);
